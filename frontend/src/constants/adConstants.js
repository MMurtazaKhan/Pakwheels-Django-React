...
export const MY_AD_LIST_REQUEST = 'MY_AD_LIST_REQUEST'
export const MY_AD_LIST_SUCCESS = 'MY_AD_LIST_SUCCESS'
export const MY_AD_LIST_FAIL = 'MY_AD_LIST_FAIL'
export const MY_AD_LIST_RESET = 'MY_AD_LIST_RESET'
...
export const AD_DETAILS_RESET = 'AD_DETAILS_RESET'
